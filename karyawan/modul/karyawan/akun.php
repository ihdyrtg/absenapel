...
<div class="row">
		...
		<div class="table-responsive">
          ...
          <tr>
					...
					<tr>
                       ...
                       <?php 
							...
							if ($adm['foto'] != "") {
								echo '<img src="../admin/img/karyawan/'.$adm['foto'].'" width="250" data-target="#view_image" data-toggle="modal">';
							}else{
								 echo '<img src="../admin/img/user_logo.png" width="150">';
							}
          ...
          <!--       <div class="modal-header">
              ...
              <!--   <div class="modal-body"> </div> -->
                <center><img src="../admin/img/karyawan/<?= $adm['foto'];?>" width="400"></center>
  ...
  <div class="form-group">
    <label>NIP</label>
    <input type="text" class="form-control" value="<?=$adm['nip'];?>" name="nip">
  ...
  <!-- <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?= $adm['divisi'];?>" id="exampleInputEmail1" name="tanggal_lahir" aria-describedby="emailHelp" placeholder="Masukkan nama">
   
  </div> -->
  <!-- <div class="form-group">
    <label>Alamat</label>
    <input type="text" class="form-control" value="<?= $adm['alamat'];?>" id="exampleInputEmail1" name="alamat" aria-describedby="emailHelp" placeholder="Masukkan nama">
   ...
   <div class="form-group">
    ...
    <br>
     <?php 
                        ...
                        if ($adm['foto']!='') {
                            echo '<img src="../admin/img/karyawan/'.$adm['foto'].'" width="250">';
                        }else{
