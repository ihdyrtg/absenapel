                  ...
                  <table class="table-responsive table-borderless table-earning" border="10">
                    <form action="" method="POST">
                      <tr>
                        <td>Divisi : </td>
                        <td><?= $adm['divisi']; ?>
                          <input type="text" hidden name="divisi" value="<?= $adm['divisi']; ?>">
                      ...
                      <tr>
                        ...
                        <td><?= $adm['nama']; ?>
                          ...
                          <!-- <input type="date" name="tanggal" value="<?= $tanggalSekarang; ?>">
                          <input type="time" name="jam" value="<?= $jamSekarang; ?>"> -->
                      ...
                      <tr>
                        ...
                        <?php if (strtotime($now) < strtotime($r['jam_masuk'])) : ?>
                          <td><button type="submit" name="simpan" class="btn btn-success" onclick="submit confirm('ingin absen?')">Absen</button></td>
                        <?php else : ?>
                          <td><button type="submit" class="btn btn-secondary">Tidak Bisa Absen Lagi</button></td>
                        <?php endif; ?>
                      </tr>
