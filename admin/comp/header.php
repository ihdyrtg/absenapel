...
<head>
    ...
    <!-- chart -->
    <link href="<?=url()?>demo/sb-admin-2.min.css" rel="stylesheet" media="all">
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="<?=url()?>images/icon/perpus.png" alt="Cool Admin" />
                </a>
            </div>
        ...
        <div class="page-container2">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="<?=url()?>images/icon/perpus.png" alt="" />
                                </a>
                            </div>
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                <div class="logo">
                    <a href="#">
                        <img src="images/icon/perpus.png" alt="Cool Admin" />
                    </a>
                </div>
